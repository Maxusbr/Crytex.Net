...
namespace Crytex.Web.Areas.User.Controllers
{
    public class PaymentGameServerController : UserCrytexController
    {
        ...
        // GET: api/Payment
        public IHttpActionResult Get(int pageNumber, int pageSize, [FromUri]SearchPaymentGameServerParams filter = null)
        {
            ...
            filter.UserId = this.CrytexContext.UserInfoProvider.GetUserId();
